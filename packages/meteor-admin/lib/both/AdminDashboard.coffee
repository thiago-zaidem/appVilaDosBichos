AdminDashboard =
	...
	panelRoutes: ['panelDashboard','panelDashboardView','panelDashboardNew','panelDashboardEdit']
...
AdminDashboard.schemas.newUser = new SimpleSchema
  ...
  chooseOwnPassword:
    type: Boolean
    label: 'Deixe o usuário escolher a sua própria senha'
    defaultValue: true
  password:
    type: String
    label: 'Password'
  ...
  sendPassword:
    type: Boolean
    label: 'Enviar a senha por e-mail'
    optional: true
  accessProfile:
    type: String
